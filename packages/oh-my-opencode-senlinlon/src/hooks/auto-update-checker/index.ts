...
// invalidatePackage and PACKAGE_NAME removed - CLI module no longer used
import { log } from "../../shared/logger"
import { getConfigLoadErrors, clearConfigLoadErrors } from "../../shared/config-errors"
// CLI module removed - auto-update now uses notification-only mode
...
async function runBackgroundUpdateCheck(
  ...
  // CLI module removed - always use notification-only mode
  await showUpdateAvailableToast(ctx, latestVersion, getToastMessage)
  log("[auto-update-checker] Update available (notification-only mode)")
}
